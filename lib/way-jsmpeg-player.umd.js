;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['way-jsmpeg-player'] = factory()
  else root['way-jsmpeg-player'] = factory()
})(this, function () {
  return /******/ (function () {
    // webpackBootstrap
    /******/ 'use strict'
                ...
                ? _c(
                    ...
                    [
                      ...
                      _vm.showTitle
                        ? [
                            _vm._v(
                              ' ' + _vm._s(_vm.recordingDurationLabel) + ' '
                            )
                          ]
                        : _vm._e()
                    ],
                ...
                ? [
                    _c(
                      'el-popover',
                      {
                        ...
                        attrs: {
                          'popper-class':
                            'jsmpeg-player-popover popover-setting',
                          trigger: 'hover',
                          placement: 'top-end',
                          ...
                          [
                            ...
                            _c(
                              ...
                              [
                                _c('button', {
                                  staticClass:
                                    'toolbar-btn jm-icon-rotate-left',
                                  attrs: {
                                    title: '向左旋转90度',
                                    type: 'button'
                                  },
                                ...
                                _c('button', {
                                  staticClass:
                                    'toolbar-btn jm-icon-rotate-right',
                                  attrs: {
                                    title: '向右旋转90度',
                                    type: 'button'
                                  },
                    ...
                    _c(
                      'el-popover',
                      {
                        ...
                        attrs: {
                          'popper-class':
                            'jsmpeg-player-popover popover-volume',
                          trigger: 'hover',
                          placement: 'top',
                          'visible-arrow': _vm.popoverVisibleArrow,
                          'append-to-body': false
        ...
        [
          ...
          },
          {
            ...
            value: function createProgram(vsh, fsh) {
              ...
              gl.attachShader(
                program,
                this.compileShader(gl.VERTEX_SHADER, vsh)
              )
              gl.attachShader(
                program,
    ...
    function decoder_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        decoder_defineProperties(Constructor.prototype, protoProps)
          ...
          },
          {
            ...
            value: function IDCT(block) {
              ...
              for (var i = 0; i < 8; ++i) {
                ...
                x1 = m0 - b1
                x2 =
                  (((block[2 * 8 + i] - block[6 * 8 + i]) * 362 + 128) >> 8) -
                  b3
                x3 = m0 + b1
                y3 = x1 + x2
                y4 = x3 + b3
        ...
        },
        {
          ...
          value: function decode() {
            ...
            if (this.destination) {
              ...
              var dy = this.instance.heapU8.subarray(
                ptrY,
                ptrY + this.codedSize
              )
    ...
    function mp2_possibleConstructorReturn(self, call) {
      if (
        call &&
        (mp2_typeof(call) === 'object' || typeof call === 'function')
      ) {
        return call
      } else if (call !== void 0) {
        throw new TypeError(
        ...
        [
                    ...
                    for (var _ch2 = 0; _ch2 < 2; _ch2++) {
                      ...
                      while (vIndex < 1024) {
                        for (var _i = 0; _i < 32; ++_i) {
                          this.U[_i] +=
                            this.D[dIndex++] * this.V[_ch2][vIndex++]
                        }
                        vIndex += 128 - 32
                        dIndex += 64 - 32
                      }
          ...
          },
          {
            ...
            value: function readAllocation(sb, tab3) {
              ...
              var qtab =
                MP2.QUANT_LUT_STEP4[tab4 & 15][this.bits.read(tab4 >> 4)]
          ...
          },
          {
            ...
            value: function readSamples(ch, sb, part) {
              ...
              if (sf === 63) {
                ...
                var shift = (sf / 3) | 0
                sf =
                  (MP2.SCALEFACTOR_BASE[sf % 3] + ((1 << shift) >> 1)) >> shift
              }
    ...
    mp2_defineProperty(
      ...
      new Float32Array([
        ...
        104.0, 100.0, 94.5, 88.5, 81.5, 73.0, 63.5, 53.0, 41.5, 28.5, 14.5,
        -1.0, -18.0, -36.0, -55.5, -76.5, -98.5, -122.0, -147.0, -173.5, -200.5,
        -229.5, -259.5, -290.5, -322.5, -355.5, -389.5, -424.0, -459.5, -495.5,
        -532.0, -568.5, -605.0, -641.5, -678.0, -714.0, -749.0, -783.5, -817.0,
        -849.0, -879.5, -908.5, -935.0, -959.5, -981.0, -1000.5, -1016.0,
        -1028.5, -1037.5, -1042.5, -1043.5, -1040.0, -1031.5, 1018.5, 1000.0,
        976.0, 946.5, 911.0, 869.5, 822.0, 767.5, 707.0, 640.0, 565.5, 485.0,
        397.0, 302.5, 201.0, 92.5, -22.5, -144.0, -272.5, -407.0, -547.5,
        -694.0, -846.0, -1003.0, -1165.0, -1331.5, -1502.0, -1675.5, -1852.5,
        -2031.5, -2212.5, -2394.0, -2576.5, -2758.5, -2939.5, -3118.5, -3294.5,
        -3467.5, -3635.5, -3798.5, -3955.0, -4104.5, -4245.5, -4377.5, -4499.0,
        -4609.5, -4708.0, -4792.5, -4863.5, -4919.0, -4958.0, -4979.5, -4983.0,
        -4967.5, -4931.5, -4875.0, -4796.0, -4694.5, -4569.5, -4420.0, -4246.0,
        -4046.0, -3820.0, -3567.0, 3287.0, 2979.5, 2644.0, 2280.5, 1888.0,
        1467.5, 1018.5, 541.0, 35.0, -499.0, -1061.0, -1650.0, -2266.5, -2909.0,
        -3577.0, -4270.0, -4987.5, -5727.5, -6490.0, -7274.0, -8077.5, -8899.5,
        -9739.0, -10594.5, -11464.5, -12347.0, -13241.0, -14144.5, -15056.0,
        -15973.5, -16895.5, -17820.0, -18744.5, -19668.0, -20588.0, -21503.0,
        -22410.5, -23308.5, -24195.0, -25068.5, -25926.5, -26767.0, -27589.0,
        -28389.0, -29166.5, -29919.0, -30644.5, -31342.0, -32009.5, -32645.0,
        -33247.0, -33814.5, -34346.0, -34839.5, -35295.0, -35710.0, -36084.5,
        -36417.5, -36707.5, -36954.0, -37156.5, -37315.0, -37428.0, -37496.0,
        ...
        1675.5, 1502.0, 1331.5, 1165.0, 1003.0, 846.0, 694.0, 547.5, 407.0,
        272.5, 144.0, 22.5, -92.5, -201.0, -302.5, -397.0, -485.0, -565.5,
        -640.0, -707.0, -767.5, -822.0, -869.5, -911.0, -946.5, -976.0, -1000.0,
        1018.5, 1031.5, 1040.0, 1043.5, 1042.5, 1037.5, 1028.5, 1016.0, 1000.5,
        981.0, 959.5, 935.0, 908.5, 879.5, 849.0, 817.0, 783.5, 749.0, 714.0,
        678.0, 641.5, 605.0, 568.5, 532.0, 495.5, 459.5, 424.0, 389.5, 355.5,
        322.5, 290.5, 259.5, 229.5, 200.5, 173.5, 147.0, 122.0, 98.5, 76.5,
        55.5, 36.0, 18.0, 1.0, -14.5, -28.5, -41.5, -53.0, -63.5, -73.0, -81.5,
        -88.5, -94.5, -100.0, -104.0, -107.5, -110.5, -112.0, -113.5, -114.0,
        -114.0, -113.5, -112.5, -111.0, -109.0, 106.5, 104.0, 101.0, 98.0, 95.0,
        91.5, 88.0, 84.5, 80.5, 77.0, 73.5, 69.5, 66.0, 62.5, 58.5, 55.5, 52.0,
        48.5, 45.5, 42.5, 39.5, 36.5, 34.0, 31.5, 29.0, 26.5, 24.5, 22.5, 20.5,
        19.0, 17.5, 15.5, 14.5, 13.0, 12.0, 10.5, 9.5, 8.5, 8.0, 7.0, 6.5, 5.5,
        5.0, 4.5, 4.0, 3.5, 3.5, 3.0, 2.5, 2.5, 2.0, 2.0, 1.5, 1.5, 1.0, 1.0,
    ...
    function mp2_wasm_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        mp2_wasm_defineProperties(Constructor.prototype, protoProps)
        ...
        },
        {
          ...
          value: function write(buffer) {
            if (this.leftoverBytes) {
              var totalLength =
                buffer.byteLength + this.leftoverBytes.byteLength
    ...
    function canvas2d_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        canvas2d_defineProperties(Constructor.prototype, protoProps)
    ...
    function ajax_progressive_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      ...
      if (staticProps)
        ajax_progressive_defineProperties(Constructor, staticProps)
      Object.defineProperty(Constructor, 'prototype', { writable: false })
      return Constructor
    }
          ...
          value: function onMessage(ev) {
            ...
            try {
              if (!this.established) {
                ...
                ;(_this$onEstablishedCa = this.onEstablishedCallback) ===
                  null || _this$onEstablishedCa === void 0
                  ? void 0
      ...
      player_createClass(Player, [
            ...
            if (options.source) {
              ...
              this.source = new source.WebSocket(
                ...
                _objectSpread(
                  ...
                  {
                    onSourceEstablished:
                      this.handleSourceEstablished.bind(this),
        ...
        },
        {
          ...
          value: function initAudio() {
            ...
            if (
              options.audio !== false &&
              audio_output.WebAudio.IsSupported()
            ) {
        ...
        },
        {
          ...
          value: function clearPlayer() {
            ...
            if (this.video.hasSequenceHeader) {
              ...
              var bufferSize =
                (_this$options$videoBu = this.options.videoBufferSize) !==
                  null && _this$options$videoBu !== void 0
        ...
        },
        {
          ...
          value: function update() {
            ...
            ;(_this$options$onUpdat = (_this$options = this.options)
              .onUpdate) === null || _this$options$onUpdat === void 0
              ? void 0
        ...
        },
        {
          ...
          value: function handleSourceEstablished() {
            ...
            ;(_this$options$onSourc2 = (_this$options3 = this.options)
              .onSourceEstablished) === null ||
            _this$options$onSourc2 === void 0
              ? void 0
    ...
    function video_element_toPrimitive(input, hint) {
      if (video_element_typeof(input) !== 'object' || input === null)
        return input
      var prim = input[Symbol.toPrimitive]
      if (prim !== undefined) {
        var res = prim.call(input, hint || 'default')
    ...
    /* harmony default export */ var utils_fullscreen = fullscreen // CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/jsmpeg-player/jsmpeg-player.vue?vue&type=script&lang=js&
    ...
    /* harmony default export */ var jsmpeg_playervue_type_script_lang_js_ = {
      ...
      computed: {
          ...
          /** @returns {number} */ get: function get() {
            ...
            return (_this$player$volume =
              (_this$player2 = this.player) === null || _this$player2 === void 0
                ? void 0
                : _this$player2.volume) !== null &&
              _this$player$volume !== void 0
              ? _this$player$volume
              : 100
          }
        },
        ...
        /** @returns {number} */ recordingDuration:
